...
var Icon = _interopDefault(require('@tds/core-decorative-icon'));
...
var StyledStep = styled.div.withConfig({
  ...
  '&:before, &:after': {
    ...
    content: "''",
    borderBottom: "0.1rem solid ".concat(coreColours.colorGreyShuttle)
  },
  '&:before': {
    left: 0
  },
...
var StyledIcon = styled.span.withConfig({
  ...
  return _extends_1({
    ...
    border: "0.1rem solid ".concat(coreColours.colorGreyShuttle),
    borderRadius: '50%',
    lineHeight: '1.7rem',
    width: '35px',
    height: '35px',
    ...
    backgroundColor: coreColours.colorPrimary,
    textAlign: 'center',
    border: "0.1rem solid ".concat(coreColours.colorPrimary)
  });
});
...
var StepTracker = function StepTracker(_ref) {
  ...
  var stepText = parseStepText(current, steps, utilHelpers.getCopy(stepTrackerText, copy).mobileStepLabel || mobileStepLabelTemplate);
  var stepLabel = getStepLabel(current, steps);
  return React.createElement(StyledStepBg, _extends_1({}, utilHelpers.safeRest(rest), {
