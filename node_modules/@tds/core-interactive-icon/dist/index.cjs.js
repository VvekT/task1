...
var StyledLimitedInteractiveIconSVG = styled__default(StyledInteractiveIconSVG)(function (_ref2) {
...
var getTheme = function getTheme(variant) {
  ...
  if (variant === 'error') {
    return {
      backgroundColor: 'transparent',
      iconColor: coreColours.colorCardinal
    };
  }
...
Limited.propTypes = {
   ...
   */
  size: utilPropTypes.responsiveProps(PropTypes.oneOf([16, 24])),
...
var CaretUp = React.forwardRef(function (props, ref) {
  return React__default.createElement(Limited, _extends_1({}, props, {
    ...
    ref: ref
  }), React__default.createElement(StyledLimitedInteractiveIconSVG, _extends_1({
    animationDirection: "up",
    viewBox: "0 0 24 24"
...
var StyledTooltip = styled__default.div.withConfig({
  ...
  maxWidth: '8.25rem',
  backgroundColor: coreColours.colorGreyShuttle,
  border: "1px solid ".concat(coreColours.colorWhite),
...
var Tooltip = function Tooltip(_ref2) {
  ...
  return React__default.createElement(StyledTooltip, _extends_1({}, props, {
    role: "tooltip",
    ref: tooltipRef,
    width: width,
    "aria-hidden": "true"
...
var getTheme$1 = function getTheme(variant) {
  ...
  return {
    ...
    iconColor: coreColours.colorGreyShuttle
  };
};
/**
 * @version ./package.json
...
var NavButton = React.forwardRef(function (_ref, ref) {
  ...
  var ariaId = utilHelpers.uniqueId(a11yText.replace(/\s+/g, '-').toLowerCase());
  return React__default.createElement(styled.ThemeProvider, {
    ...
    as: tag,
    ref: ref
  }), React__default.createElement(StyledInteractiveIconHover, null), children), React__default.createElement(Tooltip, {
    id: ariaId
  }, a11yText)));
});
...
var CartEmptyBold = React.forwardRef(function (_ref, ref) {
  var copy = _ref.copy,
      props = objectWithoutProperties(_ref, ["copy"]);

  return React__default.createElement(NavButton, _extends_1({}, props, {
    ref: ref,
    a11yText: utilHelpers.getCopy(cartEmptyBoldCopyDictionary, copy).a11yText,
...
var CartFilledBold = React.forwardRef(function (_ref, ref) {
  var copy = _ref.copy,
      variant = _ref.variant,
      numItems = _ref.numItems,
      props = objectWithoutProperties(_ref, ["copy", "variant", "numItems"]);

  var a11yText = utilHelpers.getCopy(cartFilledBoldCopyDictionary, copy).a11yText;
  ...
  return React__default.createElement(NavButton, _extends_1({}, props, {
    ...
    fill: variant === 'inverted' ? coreColours.colorTelusGreen : coreColours.colorAccessibleGreen
  }))));
});
...
var NotifyBold = React.forwardRef(function (_ref, ref) {
  var copy = _ref.copy,
      props = objectWithoutProperties(_ref, ["copy"]);

  return React__default.createElement(NavButton, _extends_1({}, props, {
    ref: ref,
    a11yText: utilHelpers.getCopy(notifyBoldCopyDictionary, copy).a11yText,
    copy: copy // Passed in to satisfy styleguidist workaround
...
var ProfileBold = React.forwardRef(function (_ref, ref) {
  var copy = _ref.copy,
      props = objectWithoutProperties(_ref, ["copy"]);

  return React__default.createElement(NavButton, _extends_1({}, props, {
    ref: ref,
    a11yText: utilHelpers.getCopy(profileBoldCopyDictionary, copy).a11yText,
    copy: copy // Passed in to satisfy styleguidist workaround
...
var SearchBold = React.forwardRef(function (_ref, ref) {
  var copy = _ref.copy,
      props = objectWithoutProperties(_ref, ["copy"]);

  return React__default.createElement(NavButton, _extends_1({}, props, {
    ref: ref,
    a11yText: utilHelpers.getCopy(searchBoldCopyDictionary, copy).a11yText,
    copy: copy // Passed in to satisfy styleguidist workaround
...
var SettingsBold = React.forwardRef(function (_ref, ref) {
  var copy = _ref.copy,
      props = objectWithoutProperties(_ref, ["copy"]);

  return React__default.createElement(NavButton, _extends_1({}, props, {
    ref: ref,
    a11yText: utilHelpers.getCopy(settingsBoldCopyDictionary, copy).a11yText,
    copy: copy // Passed in to satisfy styleguidist workaround
...
var SupportBold = React.forwardRef(function (_ref, ref) {
  var copy = _ref.copy,
      props = objectWithoutProperties(_ref, ["copy"]);

  return React__default.createElement(NavButton, _extends_1({}, props, {
    ref: ref,
    a11yText: utilHelpers.getCopy(supportBoldCopyDictionary, copy).a11yText,
    copy: copy // Passed in to satisfy styleguidist workaround
...
var UserAddBold = React.forwardRef(function (_ref, ref) {
  var copy = _ref.copy,
      props = objectWithoutProperties(_ref, ["copy"]);

  return React__default.createElement(NavButton, _extends_1({}, props, {
    ref: ref,
    a11yText: utilHelpers.getCopy(userAddBoldCopyDictionary, copy).a11yText,
    copy: copy // Passed in to satisfy styleguidist workaround
...
exports.CartEmptyBold = CartEmptyBold;
exports.CartFilledBold = CartFilledBold;
...
exports.SupportBold = SupportBold;
exports.UserAddBold = UserAddBold;
