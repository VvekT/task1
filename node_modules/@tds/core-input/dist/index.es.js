...
var FeedbackIcon = function FeedbackIcon(_ref) {
  ...
  return React.createElement(Fade, {
    ...
    return React.createElement(StyledIcon, null, renderIcon(feedback));
  });
};
...
var StyledFeedbackIcon = styled.div.withConfig({
  ...
  right: '1rem'
}, position.absolute, position.centerVertically);
...
var Input = React.forwardRef(function (_ref4, ref) {
  var id = _ref4.id,
      value = _ref4.value,
      type = _ref4.type,
      label = _ref4.label,
  ...
  return React.createElement(Box, {
    between: 2
  }, renderLabel(fieldId.identity(), label, hint, hintPosition, hintId, tooltip), helper && renderHelper(helper, helperId, feedback, value), error && renderError(error, errorId), React.createElement(_StyledDiv, {
    _css: {
      position: 'relative'
    }
  }, React.createElement(StyledInput, _extends_1({}, safeRest(rest), {
    type: type,
    ref: ref,
    id: fieldId.identity(),
    value: value,
