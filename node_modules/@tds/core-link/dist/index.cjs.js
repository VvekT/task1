...
var base = _extends_1({}, sharedStyles.links.focusOutline, {
  '&:link,&:visited': {
...
var Link = function Link(_ref4, context) {
  ...
  var renderChildren = React.useCallback(function () {
    if (Icon) {
      return React__default.createElement(React__default.Fragment, null, iconPosition === 'left' && React__default.createElement(Icon, {
        color: invert ? 'white' : 'greyShark',
        style: {
          marginRight: '0.5rem'
        }
      }), children, iconPosition === 'right' && React__default.createElement(Icon, {
        color: invert ? 'white' : 'greyShark',
        style: {
          marginLeft: '0.25rem'
        }
  ...
  return React__default.createElement(StyledLink, _extends_1({}, utilHelpers.safeRest(rest), {
...
Link.propTypes = {
   ...
   * @since 2.2.0
   */
  icon: utilPropTypes.componentWithName('Dependent', true),
...
var Link$1 = sharedHocs.withForwardedRef(Link);
