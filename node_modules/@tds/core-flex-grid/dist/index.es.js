...
var Col = function Col(_ref4) {
  ...
  return React.createElement(GutterContext.Consumer, null, function (gutter) {
    return React.createElement(StyledCol, _extends_1({}, safeRest(props), {
...
var Row = function Row(_ref5) {
  ...
  return React.createElement(StyledRow, _extends_1({}, safeRest(rest), {
...
var rem = function rem(breakpoint) {
  return pixelToRem(breakpoints[breakpoint]);
};
...
var StyledGrid = styled.div.withConfig({
  ...
  }), {}, media.from('sm').css(_extends_1({}, limitWidth && {
    maxWidth: rem('sm')
  }, {
    flexDirection: reverseLevel[1] ? 'column-reverse' : 'column'
  })), {}, media.from('md').css(_extends_1({}, limitWidth && {
    maxWidth: rem('md')
  }, {
    flexDirection: reverseLevel[2] ? 'column-reverse' : 'column'
  })), {}, media.from('lg').css(_extends_1({}, limitWidth && {
    maxWidth: rem('lg')
  }, {
    flexDirection: reverseLevel[3] ? 'column-reverse' : 'column'
  })), {}, media.from('xl').css(_extends_1({}, limitWidth && {
    maxWidth: rem('xl')
  }, {
...
var FlexGrid = function FlexGrid(_ref2) {
  ...
  return React.createElement(GutterContext.Provider, {
    value: gutter
  }, React.createElement(StyledGrid, _extends_1({}, safeRest(rest), {
