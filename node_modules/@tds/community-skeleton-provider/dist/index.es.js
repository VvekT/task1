...
import Text$1 from '@tds/core-text';
import Heading$1 from '@tds/core-heading';
import Image$1 from '@tds/core-image';
...
}, colorGainsboro, colorGainsboro, colorAthensGrey, colorGainsboro, skeletonTextShimmer);
/**
...
var Skeleton = function Skeleton(_ref3) {
  ...
  return React.createElement(StyledSkeleton, _extends_1({}, safeRest(rest), {
...
function SkeletonRenderer(props) {
  var skeleton = useContext(SkeletonContext);
    ...
    return function wrapper(_ref) {
      ...
      return React.createElement(SkeletonRenderer, {
        skeleton: function skeleton() {
          return React.createElement(SkeletonComponent, _extends_1({
            skeleton: _skeleton
          }, props));
        },
...
var HeadingSkeleton = function HeadingSkeleton(_ref) {
  ...
  if (!skeleton) {
    return React.createElement(Heading$1, rest);
  }
  ...
  return React.createElement(StyledHeadingSkeleton, null, React.createElement(Skeleton, {
    characters: characters,
...
var TextSkeleton = function TextSkeleton(_ref) {
  ...
  if (!skeleton) {
    return React.createElement(Text$1, rest);
  }
  ...
  return React.createElement(StyledTextSkeleton, null, toConsumableArray(Array(lines)).map(function (_, idx) {
...
var StyledImageSkeleton = styled.div(_templateObject2$1(), getWidthHeight, colorGainsboro, colorGainsboro, colorAthensGrey, colorGainsboro, skeletonTextShimmer$1);
var StyledRoundedCornersImageSkeleton = styled(StyledImageSkeleton)(_templateObject3(), borders.rounded, function (props) {
  return props.width;
}, function (props) {
  return props.height;
});
...
var ImageSkeleton = function ImageSkeleton(_ref2) {
  ...
  if (!skeleton) {
    return React.createElement(Image$1, rest);
  }

  var rounded = rest.rounded;

  if (rounded === 'corners') {
    return React.createElement(StyledRoundedCornersImageSkeleton, safeRest(rest));
  }

  return React.createElement(StyledImageSkeleton, safeRest(rest));
};
...
var AutoSkeletonizer = function AutoSkeletonizer(children) {
  var skeletonChildren = React.Children.map(children, function (childElement) {
    ...
    if (child.props && 'skeleton' in child.props && typeof child.props.skeleton === 'function') {
      ...
      return React.createElement(EnhancedChild, child.props);
    }

    if (child.type === Text$1) {
      return React.createElement(Skeletons.Text, child.props);
    }

    if (child.type === Heading$1) {
      return React.createElement(Skeletons.Heading, child.props);
    }

    if (child.type === Image$1) {
      return React.createElement(Skeletons.Image, child.props);
    }
...
var SkeletonContext = createContext({
  show: true
});
...
function SkeletonProvider(_ref) {
  ...
  return React.createElement(SkeletonContext.Provider, _extends_1({
    value: {
      show: show
    }
