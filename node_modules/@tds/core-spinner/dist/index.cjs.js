...
var SvgCircle = styled.circle.withConfig({
  ...
  return variant === 'primary' && "stroke: ".concat(coreColours.colorAccessibleGreen);
}, function (_ref5) {
  var variant = _ref5.variant;
  return variant === 'secondary' && "stroke: ".concat(coreColours.colorSecondary);
});
...
var SpinnerSvg = function SpinnerSvg(_ref6) {
  ...
  var titleId = utilHelpers.uniqueId('spinner-title-');
  return React.createElement(SvgContainer, {
    overlay: overlay,
    "data-testid": "spinner"
  }, React.createElement(StyledSvg, _extends_1({}, utilHelpers.safeRest(rest), {
    viewBox: "0 0 100 100",
...
var SpinnerContainer = styled.div.withConfig({
  ...
  return _extends_1({}, sharedStyles.position.relative, {}, inline && _extends_1({
    display: 'block'
  }, coreResponsive.media.from('md').css({
    display: 'inline-block'
  })), {}, fullScreen && sharedStyles.position.centerVertically);
});
  ...
  createClass(Spinner, [{
    ...
    value: function render() {
      ...
      var spinnerSvg = function spinnerSvg(props) {
        return React.createElement(SpinnerSvg, _extends_1({}, props, utilHelpers.safeRest(rest), {
