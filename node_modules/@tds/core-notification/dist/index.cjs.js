...
var StyledNotificationContainer = styled(function (_ref) {
  ...
  return _extends_1({
    ...
    instructional: sharedStyles.messaging.standard,
    success: sharedStyles.messaging.success,
    error: sharedStyles.messaging.error,
    warning: sharedStyles.messaging.warning,
    branded: {
...
var renderIcon = function renderIcon(variant, copy) {
  var feedback = utilHelpers.getCopy(copyDictionary, copy).feedback;
  var iconCopy = _typeof_1(copy) === 'object' && copy.feedback ? {
    a11yText: feedback
  } : feedback;

  if (variant === 'success') {
    return React.createElement(coreFeedbackIcon.NotificationSuccess, {
      copy: iconCopy
    });
  }

  if (variant === 'error') {
    return React.createElement(coreFeedbackIcon.NotificationError, {
      copy: iconCopy
    });
  }

  if (variant === 'warning') {
    return React.createElement(coreFeedbackIcon.NotificationWarning, {
      copy: iconCopy
    });
  }
...
function (_React$Component) {
  ...
  createClass(Notification, [{
    ...
    value: function renderNotification() {
      ...
      return React.createElement(StyledNotificationContainer, _extends_1({}, utilHelpers.safeRest(rest), {
        vertical: 3,
        variant: variant
        ...
        vertical: 1
      }, renderIcon(variant, copy)), React.createElement(Paragraph, null, children)), dismissible && React.createElement(StyledDismissButtonWrapper, null, React.createElement(coreInteractiveIcon.IconButton, {
        icon: coreInteractiveIcon.Close,
        a11yText: utilHelpers.getCopy(copyDictionary, copy).close,
    ...
    value: function render() {
      ...
      if (dismissible) {
        ...
        return React.createElement(sharedAnimation.Reveal, {
          ...
          return React.createElement(sharedAnimation.Fade, {
