...
var renderLabel = function renderLabel(id, label, hint, hintId, tooltip) {
  return React__default.createElement(Box, {
    ...
    size: "medium",
    bold: true
  }, label), hint && renderHint(hint, Text, hintId))), tooltip && React__default.cloneElement(tooltip, {
...
var TextArea = React__default.forwardRef(function (_ref4, ref) {
  var id = _ref4.id,
      value = _ref4.value,
      label = _ref4.label,
      hint = _ref4.hint,
  ...
  return React__default.createElement(Box, {
    between: 2
  }, renderLabel(fieldId.identity(), label, hint, hintId, tooltip), helper && renderHelper(helper, helperId, feedback, value), error && feedback === 'error' && renderError(error, errorId), React__default.createElement(PreventWidthResize, null, React__default.createElement(StyledTextArea, _extends_1({}, utilHelpers.safeRest(rest), {
    ref: ref,
    id: fieldId.identity(),
    value: value,
    feedback: feedback,
  ...
  })), !rest.disabled && React__default.createElement(StyledFeedbackIcon, null, React__default.createElement(coreInput.FeedbackIcon, {
