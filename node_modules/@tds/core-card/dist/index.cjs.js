...
var Image = _interopDefault(require('@tds/core-image'));
...
})(sharedStyles.borders.none, sharedStyles.borders.rounded, getVariant, function (_ref3) {
...
var fullBleedImageStyles = function fullBleedImageStyles(fullBleedImage) {
  return fullBleedImage && fullBleedImage.position && utilHelpers.handleResponsiveStyles({
...
var Card = function Card(_ref7) {
  ...
  if (fullBleedImage) {
    return React.createElement(StyledCard, _extends_1({}, utilHelpers.safeRest(rest), {
...
Card.propTypes = {
  ...
  fullBleedImage: PropTypes.shape({
    ...
    position: utilPropTypes.responsiveProps(PropTypes.oneOf(['left', 'right', 'top', 'bottom', 'none'])).isRequired
  })
};
Card.defaultProps = {
  variant: 'default',
