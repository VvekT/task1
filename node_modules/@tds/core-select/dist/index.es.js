...
import { position, forms, borders } from '@tds/shared-styles';
import { colorWhite, colorGreyShuttle, colorGreyAthens, colorPrimary, colorCardinal } from '@tds/core-colours';
...
}, borders.thin, borders.rounded, forms.font, medium, mediumFont, color, function (_ref2) {
...
var IconWrapper = styled(Box)(_extends_1({}, position.absolute, {
  top: '50%',
...
var renderLabel = function renderLabel(id, label, hint, hintPosition, hintId, tooltip) {
  ...
  }, label), hint && hintPosition === 'inline' && renderHint(hint, Text, hintId))), tooltip && React.cloneElement(tooltip, {
...
var Select = React.forwardRef(function (_ref6, ref) {
  var id = _ref6.id,
  ...
  return React.createElement(Box, {
    between: 2
  }, renderLabel(fieldId.identity(), label, hint, hintPosition, hintId, tooltip), helper && renderHelper(helper, helperId, feedback, value), error && feedback === 'error' && renderError(error, errorId), React.createElement(_StyledDiv, {
    _css: {
      position: 'relative'
    }
  }, React.createElement(SelectWrapper, null, React.createElement(StyledSelect, _extends_1({}, safeRest(rest), {
    ref: ref,
    id: fieldId.identity(),
    value: value,
    feedback: feedback,
    ...
    value: "",
    disabled: true
  }, placeholder), renderOptions(options)), !rest.disabled && React.createElement(IconWrapper, {
    inline: true,
    between: 1
  }, React.createElement(FeedbackIcon, {
    showIcon: showFeedbackIcon(feedback) && !isFocused,
    feedback: feedback
  }), React.createElement(IconLineFix, null, React.createElement(CaretDown, {
