...
var FlexGrid = _interopDefault(require('@tds/core-flex-grid'));
...
var StyledHairlineDivider = styled__default.hr.withConfig({
  ...
  if (props.vertical && props.gradient) {
    return _extends_1$3({}, verticalStyle, {
      'background-image': "\n        linear-gradient(0deg, rgba(216, 216, 216, 0) 0%,\n        ".concat(coreColours.colorGreyGainsboro, " 12%,\n        ").concat(coreColours.colorGreyGainsboro, " 88%,\n        rgba(216, 216, 216, 0) 100%)\n      ")
    });
  }

  if (props.vertical && !props.gradient) {
    return _extends_1$3({}, verticalStyle, {
      'background-color': coreColours.colorGreyGainsboro
    });
  }

  if (!props.vertical && props.gradient) {
    return _extends_1$3({}, horizontalStyle, {
      'background-image': "\n        linear-gradient(90deg, rgba(216, 216, 216, 0) 0%,\n        ".concat(coreColours.colorGreyGainsboro, " 7%,\n        ").concat(coreColours.colorGreyGainsboro, " 93%,\n        rgba(216, 216, 216, 0) 100%)\n      ")
    });
  }
...
var HairlineDivider = function HairlineDivider(_ref) {
  ...
  return React__default.createElement(StyledHairlineDivider, _extends_1$3({}, utilHelpers.safeRest(rest), {
    vertical: vertical,
    gradient: gradient
  }));
};
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    React__default.Children.only(children) && typeof React__default.Children.only(children).type === "string" ? React__default.Children.only(children) : React__default.cloneElement(React__default.Children.only(children), {
      matches: matches
    }) : null : null : null;
  };
...
var Responsive = function Responsive(_ref) {
  ...
  return React__default.createElement(Media, _extends_1$4({}, rest, {
...
var StyledDimpleDivider = styled__default.hr.withConfig({
...
var DimpleDivider = function DimpleDivider(_ref) {
  ...
  return React__default.createElement(StyledDimpleDivider, utilHelpers.safeRest(rest));
};
...
var TabsContainer = styled__default.div(_templateObject(), coreColours.colorGreyShark, function (props) {
  return props.wrapLabels && styled.css([".react-tabs__tab-list{display:flex;position:relative;}.react-tabs__tab{flex:0 0 auto;display:flex;white-space:initial;}"]);
});
var TabBorder = styled__default.div(_templateObject2());
var TabListOuterContainer = styled__default.div(_templateObject3());
var TabListContainer = styled__default.div(_templateObject4(), function (props) {
  return props.positionToMove;
}, function (props) {
  return props.wrapLabels ? 'normal' : 'nowrap';
});
var TabLabel = styled__default.h4(_templateObject5(), function (props) {
  return props.wrapLabel && styled.css(["max-width:144px;display:flex;align-items:center;justify-content:center;"]);
});
var TabArrows = styled__default.div(_templateObject6(), function (props) {
  return props.direction === 'left' && styled.css(["left:0;padding-right:7px;"]);
}, function (props) {
  return props.direction === 'right' && styled.css(["right:0;padding-left:7px;"]);
});
var ArrowInner = styled__default.div(_templateObject7(), coreColours.colorWhite, function (props) {
  return props.direction === 'left' && styled.css(["border-right:1px solid ", ";"], coreColours.colorGreyGainsboro);
}, function (props) {
  return props.direction === 'right' && styled.css(["border-left:1px solid ", ";"], coreColours.colorGreyGainsboro);
});

var pseudoBar = function pseudoBar(isSelected) {
  return "\n  content: '';\n  position: absolute;\n  left: 10px;\n  right: 10px;\n  bottom: 0;\n  border-top: solid 4px ".concat(isSelected ? coreColours.colorGreyRaven : coreColours.colorGreyGainsboro, ";\n");
};

var TabLabelContainer = styled__default.button(_templateObject8(), pseudoBar(false), pseudoBar(true), pseudoBar(true));
...
var Tabs = function Tabs(props) {
  ...
  var LEFT_ARROW = 37;
  var TAB = 9;
  var currentFocus = React.useRef(0);
  var tabsRoot = React.useRef();
  var tabRef = React.useRef(null);
  var tabNavRef = React.useRef(null);
  var tabScrollIntervals = React.useRef([]);
  var tabScrollPosition = React.useRef(0); // 0,1,2... to keep track of the scroll page

  var tabArrowKeyIntervals = React.useRef([]); // list of tab indices where scrolling should happen

  var tabIsFocused = React.useRef(false); // checks if any of the tabs are in focus
  ...
  var wasTabbedPastTabs = React.useRef(false);
  var finalScrollLeftTabPos = React.useRef(null); // keeps track of the left most visible tab on final scroll
    ...
    if (props.children.length > 0) {
      return props.children.map(function (tab, i) {
        return React__default.createElement(reactTabs.Tab, {
          ...
          ref: tabNavRef
        }, React__default.createElement(TabLabelContainer, null, React__default.createElement(TabLabel, {
          tabIndex: "-1",
    ...
    if (props.children.length > 0) {
      return props.children.map(function (tab, i) {
        return React__default.createElement(reactTabs.TabPanel, {
          key: hash(i)
        }, React__default.createElement(FlexGrid, null, React__default.createElement(FlexGrid.Row, null, React__default.createElement(FlexGrid.Col, {
          xs: 12,
          tabIndex: "0"
        }, React__default.createElement(Panel, rest, children[current])))));
      });
    }
  ...
  return React__default.createElement(TabsContainer, _extends_1({}, utilHelpers.safeRest(rest), {
    wrapLabels: wrapLabels,
    ref: tabsRoot
  }), React__default.createElement(FlexGrid, {
    gutter: false
  }, React__default.createElement(FlexGrid.Row, null, React__default.createElement(FlexGrid.Col, {
    xs: 12
  }, React__default.createElement(reactTabs.Tabs, {
    selectedIndex: open ? current : undefined,
    onSelect: onOpen ? handleSelect : undefined
  }, React__default.createElement(TabBorder, null, isLeftArrowVisible && React__default.createElement(TabArrows, {
    tabIndex: "0",
    direction: "left",
  ...
  }, React__default.createElement(ArrowInner, {
    direction: "left"
  }, React__default.createElement(coreInteractiveIcon.ChevronLeft, {
    variant: "basic"
  }))), React__default.createElement(TabListOuterContainer, null, React__default.createElement(TabListContainer, {
    ref: tabRef,
  ...
  }, mapTabs()))), isRightArrowVisible && React__default.createElement(TabArrows, {
    tabIndex: "0",
    direction: "right",
    ...
    direction: "right"
  }, React__default.createElement(coreInteractiveIcon.ChevronRight, {
    variant: "basic"
  })))), React__default.createElement(HairlineDivider, null), React__default.createElement(DimpleDivider, null), mapTabContent())))));
};
