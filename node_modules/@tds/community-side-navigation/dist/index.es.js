...
import { colorWhiteLilac, colorTelusPurple, colorShuttleGrey, colorGainsboro } from '@tds/core-colours';
...
var activeContainer = {
  borderLeft: "4px solid ".concat(colorTelusPurple),
  color: "".concat(colorTelusPurple),
  backgroundColor: "".concat(colorWhiteLilac)
};
var activeText = {
  fontWeight: 'bold',
  color: "".concat(colorTelusPurple)
...
var BoxContainer = styled(Box)(function (props) {
  return _extends_1({
    ...
    borderLeft: props.submenulink ? "4px solid ".concat(colorWhiteLilac) : 'none'
  }, props.active && !props.submenulink ? activeContainer : undefined);
});
var BoxWrapper = styled(Box)(function (props) {
  return {
    backgroundColor: props.active ? "".concat(colorWhiteLilac) : 'none'
  };
});
var BoxActive = styled(Box)(function (props) {
  return {
    borderLeft: props.active && props.submenulink ? "4px solid ".concat(colorTelusPurple) : 'none',
...
var Link = function Link(_ref) {
  ...
  var innerLink = React.createElement(BoxWrapper, {
    active: active ? 1 : 0
  }, React.createElement(BoxContainer, {
    vertical: 3,
    submenulink: subMenuLink ? 1 : 0,
    active: active ? 1 : 0
  }, React.createElement(BoxActive, {
    active: active ? 1 : 0,
    horizontal: 3,
    submenulink: subMenuLink ? 1 : 0
  }, React.createElement(StyledTextProvider, {
    active: active
  }, React.createElement(Text, {
    size: subMenuLink ? 'small' : 'medium',
    bold: active
  }, children)))));
  return React.createElement(reactRouterLinkComponent || StyledAnchor, _extends_1({}, safeRest(rest)), innerLink);
};
...
var ButtonSubMenu = styled.button(function (props) {
  return {
    ...
    border: 'none',
    width: '100%',
    color: props.active && !props.isOpen ? "".concat(colorTelusPurple) : "".concat(colorShuttleGrey),
    borderLeft: props.active && !props.isOpen ? "4px solid ".concat(colorTelusPurple) : 'none',
    fontFamily: "".concat(fontTelus),
    '&:hover': {
      backgroundColor: "".concat(colorWhiteLilac),
      color: "".concat(colorTelusPurple),
      cursor: 'pointer'
...
function (_React$Component) {
  ...
  createClass(SubMenu, [{
    ...
    value: function render() {
      ...
      return React.createElement(React.Fragment, null, React.createElement(ButtonSubMenu, _extends_1({}, safeRest(rest), {
        onClick: this.handleClick,
        active: activeChild,
        "aria-expanded": isOpen,
        isOpen: isOpen
      }), React.createElement(SpaceBox, {
        vertical: 3,
        inline: true,
        horizontal: 2
      }, React.createElement(ColoredTextProvider, null, React.createElement(Text, {
        size: "medium",
        bold: activeChild
      }, label)), React.createElement(DecorativeIcon, {
        symbol: isOpen ? 'caretUp' : 'caretDown',
        variant: "secondary",
        size: 16
      }))), React.createElement(FadeAndReveal, {
        ...
        return React.createElement(SubMenuContainer, {
          ref: function ref(c) {
            _this2.subMenu = c;
          }
        }, React.Children.map(children, function (child) {
          return React.createElement("li", null, React.cloneElement(child, _this2.options));
        }));
      }));
    }
  }]);
...
var StyledUl = styled.ul({
  ...
  margin: '0',
  borderTop: "1px solid ".concat(colorGainsboro)
});
var StyledLi = styled.li({
  borderBottom: "1px solid ".concat(colorGainsboro),
  alignItems: 'center',
  lineHeight: '0'
});
/**
...
function (_Component) {
  ...
  function SideNavigation(props) {
    ...
    _this._sideNav = React.createRef();
    return _this;
  }
  ...
  createClass(SideNavigation, [{
    ...
    value: function render() {
      ...
      return React.createElement(DivContainer, _extends_1({}, safeRest(rest), {
        ref: function ref(c) {
        ...
        size: "large",
        bold: true
      }, category)), React.createElement(StyledUl, null, React.Children.map(children, function (child, index) {
        var options = {};
        ...
        return React.createElement(StyledLi, null, React.cloneElement(child, options));
      })))));
    }
  }]);
