...
var defaultStyle$3 = function defaultStyle(duration, timeout, state) {
  return {
    transition: "height ".concat(duration || timeout, "ms, opacity ").concat(duration || timeout, "ms ease-in-out"),
    opacity: 0,
    height: 0,
    overflow: 'hidden',
...
var transitionStyles$3 = function transitionStyles(height) {
  return function (duration, timeout) {
    return {
      entering: {
        opacity: 1,
        height: height
...
var FadeAndReveal = function FadeAndReveal(_ref) {
  var delay = _ref.delay,
      height = _ref.height,
      children = _ref.children,
      rest = objectWithoutProperties(_ref, ["delay", "height", "children"]);

  return React.createElement(reactTransitionGroup_1, rest, function (state) {
    return React.createElement(StyledContainer$1, {
      style: _extends_1({}, defaultStyle$3(rest.duration, rest.timeout, state), transitionStyles$3(height)(rest.duration, rest.timeout)[state]),
