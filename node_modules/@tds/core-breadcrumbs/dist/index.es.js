...
var item = _extends_1({
  display: 'inline'
}, sizeSmall, {}, media.from('md').css(_extends_1({}, sizeMedium)));
...
var Item = forwardRef(function (_ref2, ref) {
  var href = _ref2.href,
  ...
  return React.createElement(StyledItemContainer, {
    tag: "li",
    isCurrent: current
  }, current ? React.createElement(Text, null, children) : React.createElement("span", null, React.createElement(Link, _extends_1({}, linkOptions, {
    ref: ref
  }), children), React.createElement(StyledSlash, {
    "aria-hidden": "true"
  }, "/")));
});
...
var Breadcrumbs = function Breadcrumbs(_ref2) {
  ...
  if (children) {
    items = React.Children.toArray(children).map(function (_ref3) {
  ...
  return React.createElement("nav", safeRest(rest), React.createElement(StyledList, null, items.map(function (_ref4) {
    var href = _ref4.href,
    ...
    return React.createElement(Item, _extends_1({}, itemRest, {
      key: href,
      href: href,
      reactRouterLinkComponent: linkComponent || reactRouterLinkComponent,
      current: current
    }), breadcrumbName);
  })), React.createElement(Helmet, null, React.createElement("script", {
