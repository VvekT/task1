        ...
        <FlexGrid gutter={false} limitWidth={false} outsideGutter={false}>
          <FlexGrid.Row>
            <FlexGrid.Col xs={12} md={8} lg={9} horizontalAlign="left">
              ...
              <Box vertical="2"></Box>
              {CasesIncidentFormConfig["requesttype"].type === "select" && (
                <>
                  <Box>
                    <legend>
                  ...
                  <ThreeGridLayout>
                    {CasesIncidentFormConfig["requesttype"].options.map(
                      (option, id) => {
                        return (
                          <Radio
                            label={option.text}
                            ...
                            value={option.value}
                            fullHeight={true}
                            checked={values.requesttype === option.value}
                            onChange={() => {
              ...
              {CasesIncidentFormConfig["destination"].type === "select" && (
                <SingleGridLayout>
                  <Field
                    as={SelectInput}
                    value={values.destination}
                    setFieldValue={setFieldValue}
                    label={CasesIncidentFormConfig["destination"].label}
                    options={CasesIncidentFormConfig["destination"].options}
                    name="destination"
                ...
                {CasesIncidentFormConfig["requestforuser"].type === "select" && (
                <SingleGridLayout>
                  <Field
                    as={SelectInput}
                    value={values.requestforuser}
                    setFieldValue={setFieldValue}
                    label={CasesIncidentFormConfig["requestforuser"].label}
                    options={CasesIncidentFormConfig["requestforuser"].options}
                    name="requestforuser"
                    errors={touched["requestforuser"] && errors["requestforuser"]}
                    tooltip={<div style={{ color: colorCardinal }}>*</div>}
                  />
                </SingleGridLayout>
              )}
              ...
              {CasesIncidentFormConfig["requesttype"].type === "select" && (
                <>
                  ...
                  <ThreeGridLayout>
                    {CasesIncidentFormConfig["requestduration"].options.map(
                      (option, id) => {
                        return (
                          <Radio
                            label={option.text}
                            ...
                            value={option.value}
                            fullHeight={true}
                            checked={values.requestduration === option.value}
                            onChange={() => {
                              setFieldValue("requestduration", option.value);
                            }}
                            tooltip={
                              <div style={{ color: colorCardinal }}>*</div>
                            }
              ...
              >
                <AttachmentContainer>
                  <IconOuterWrapper>
                    ...
                    <TextWrapper
                      inline
                      additionalProps={{ paddingLeft: "30px" }}
                    >
